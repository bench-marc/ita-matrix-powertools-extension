import { convertToQueryParams, dateObjectToFormatedString, convertArrayToFlatObject, printError } from '../utils';
...
function canGetBudgetairUrl(currentItin: ICurrentItin) {
    return currentItin.itin.length <= 3;
}

function getBudgetairUrl(currentItin: ICurrentItin, host: string) {
...
export function getBudgetairUrls(currentItin: ICurrentItin) {
